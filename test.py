import pandas as pd
from salads_dataset import create_salad_df_from_initial_df, save_df_csv, ingrident_counter, get_salad_dataset
...
'''
print(ingrident_counter(get_salad_dataset(DATA_PATH)))